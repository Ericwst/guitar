...
public class SQLiteTest {
    public static void main(String[] args) {
        try {
            ...
            String fileName = "F:/sqlitestudio/guitar";
            // Driver to Use
            ...
            while (rs.next()) {
                ...
                String code = rs.getString("serialNumber"); // Column 2
                String name = rs.getString("price"); // Column 3
                System.out.println("ID: "+id+" serialNumber: "+code+" price: "+name);
